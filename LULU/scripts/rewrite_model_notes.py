...
NOTES_MAP: dict[str, dict[str, str]] = {
    "WACC": {
        ...
        "Equity risk premium": "Damodaran US ERP (Jan-26).",
    ...
    "NOPAT Bridge": {
        ...
        "= Adjusted EBIT (Phase 1)": "Reported EBIT plus non-recurring add-backs (10-K).",
        "Adjusted EBIT": "Reported EBIT plus non-recurring add-backs (10-K).",
        ...
        "= EBIT after lease & capitalization (Phase 2)": "Lease interest and R&D capitalization adjustments.",
        "EBIT after lease & capitalization": "Lease interest and R&D capitalization adjustments.",
