...
JUST = {
    ...
    "sc_capex_pct": "FY26 7% is $735M on guided $10.4B sales, not FY25 $11.1B. 5.5% blend = (7+6+5.5+5+4)/5.",
    ...
    "3s_capex_pct": "FY26 7% is $735M / $10.4B sales, not / $11.1B. Then 6.0 / 5.5 / 5.0 / 5.0 after the spike.",
