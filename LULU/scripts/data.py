...
SOURCE_HINT = {
    ...
    "sc_capex_pct": 'Ctrl+F "680,802" → FY25 $680.8M / $11.1B = 6.1%. Ctrl+F "$725.0 million and $745.0 million" → FY26 mid $735M / $10.4B sales = 7.0% (not ÷ $11.1B). Since it goes 7.0% toward FY25 6.1%, we assume a fade: DCF 5.5% = (7.0+6.0+5.5+5.0+4.0)/5.',
    ...
    "3s_capex_pct": 'Ctrl+F "680,802" → FY25 6.1%. Ctrl+F "$725.0 million and $745.0 million" → FY26 $735M / $10.4B = 7.0%. Since 7.0% steps toward FY25 6.1%, we assume a fade: 7.0 / 6.0 / 5.5 / 5.0 / 5.0.',
