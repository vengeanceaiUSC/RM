...
SOURCE_HINT = {
    ...
    "sc_m1": 'Ctrl+F "operating margin" → "18.8%" Q2 FY2026; FY26 full-year 13.9% EBIT margin = model',
    ...
    "sc_tax": 'Ctrl+F "Income tax expense" → 659,784 ÷ "Income before income tax expense" 2,238,967',
    "sc_da_pct": 'Ctrl+F "Depreciation and amortization" → 496,228; ÷ "Net revenue" 11,102,600 = 4.5%',
    "sc_capex_pct": 'Ctrl+F "680,802" → capex ($000) in investing; ÷ revenue 11,102,600; model 5.0%',
    ...
    "3s_sga_pct": 'Ctrl+F "Selling, general and administrative expenses" → 4,066,556 ÷ revenue 11,102,600',
    "3s_other_opex": 'Ctrl+F "Amortization of intangible assets" → 6,961 ($000); model $7,000/yr',
    "3s_other_inc": 'Ctrl+F "Other income (expense), net" → 28,352 ($000) FY25; model steps down',
    "3s_tax_rate": 'Ctrl+F "Income tax expense" → 659,784 ÷ "Income before income tax expense" 2,238,967 = 29.5%',
    "3s_da_pct": 'Ctrl+F "Depreciation and amortization" → 496,228 ÷ "Net revenue" 11,102,600 = 4.5%',
    "3s_capex_pct": 'Ctrl+F "680,802" → capex ($000); ÷ revenue 11,102,600 = 6.1%; model fades to 5.0%',
    "3s_sbc": 'Ctrl+F "Stock-based compensation expense" → 62,203 ($000); model $70,000',
    ...
    "3s_oca_pct": 'Ctrl+F "Prepaid expenses and other current assets" → 211,620 ÷ revenue = 1.9% FY25',
    "3s_rou_pct": 'Ctrl+F "Right-of-use lease assets" → 1,630,181 ÷ "Net revenue" 11,102,600 = 14.7%',
    "3s_onca_pct": 'Ctrl+F "Deferred income tax assets" → in non-current assets; model 3.0% of revenue',
    ...
    "3s_ocl_pct": 'Ctrl+F "Other current liabilities" → 45,954 | "Unredeemed gift card liability" → 316,632',
