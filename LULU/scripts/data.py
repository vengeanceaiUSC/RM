...
JUST = {
    ...
    "drv_f_geo_scale": "Hold the FY25 geo mix, scale each region by how much total revenue grew vs last year. Quick way to split the top line.",
...
SOURCE_HINT = {
    ...
    "drv_f_geo_scale": "=FY25 geo rev × (this year's total rev ÷ FY25 total rev). Keeps mix, moves with consolidated growth.",
