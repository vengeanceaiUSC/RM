...
JUST = {
    ...
    "sc_capex_pct": "7.0% = $735M ÷ the $10.4B FY26 sales year, not ÷ FY25 $11.1B (that would be 6.6%). $10B year + higher spend = the % spike.",
    "sc_capex_sales": "FY26 sales are the guided $10.35–$10.50B year (~$10.4B). FY25 was $11.1B. Same capex math must use the $10B denominator.",
    ...
    "3s_capex_pct": "FY26 7.0% = $735M ÷ ~$10.4B guided sales (the $10B year), not ÷ FY25 $11.1B. Then 6.0 / 5.5 / 5.0 / 5.0 back toward FY25 6.1%.",
...
SOURCE_HINT = {
    ...
    "sc_capex_pct": 'Ctrl+F "680,802" → FY25 capex $680.8M. Ctrl+F "11,102,600" → FY25 sales $11.1B. 680.8 / 11,102.6 = 6.1%. Ctrl+F "$725.0 million and $745.0 million" → FY26 capex mid $735M. Do not divide $735M by FY25 $11.1B (6.6%). FY26 is a $10B sales year: $735M / $10.425B = 7.0%. Then fade 6.0 / 5.5 / 5.0 / 4.0. DCF 5.5% = (7.0+6.0+5.5+5.0+4.0)/5.',
    "sc_capex_sales": 'Ctrl+F "$10.350 billion to $10.500 billion" → FY26 net revenue guide (one hit). Mid $10.425B. That is the $10B year vs FY25 $11.1B. 7.0% capex uses this $10.4B denominator.',
    ...
    "3s_capex_pct": 'Ctrl+F "680,802" → FY25 $680.8M on $11.1B sales = 6.1%. Ctrl+F "$725.0 million and $745.0 million" → FY26 $735M. Divide by the $10B year ($10.425B guide), not by $11.1B: 735 / 10,425 = 7.0%. Path 7.0 / 6.0 / 5.5 / 5.0 / 5.0.',
