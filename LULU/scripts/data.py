...
JUST = {
    ...
    "sc_capex_pct": "FY26 is up vs FY25: $735M / 7.0% vs $681M / 6.1% (sales fall, spend rises). 5.5% = (7.0+6.0+5.5+5.0+4.0)/5 after that spike.",
    ...
    "3s_capex_pct": "FY26 7.0% is up vs FY25 6.1% ($735M vs $681M). Then 6.0 / 5.5 / 5.0 / 5.0 returns toward the FY25 run-rate and the 4.5% D&A floor.",
...
SOURCE_HINT = {
    ...
    "sc_capex_pct": 'Ctrl+F "680,802" (one hit) → FY25 PP&E $680.8M ÷ 11,102,600 = 6.1%. Ctrl+F "$725.0 million and $745.0 million" → FY26 guide mid $735M ÷ $10,425M sales = 7.0%. FY26 is higher than FY25 in both $ ($735M vs $681M) and % (7.0% vs 6.1%): sales fall 6%, spend rises. FY27 6.0% is the step back to the FY25 6.1% run-rate after that one-year spike. Then 5.5 / 5.0 / 4.0 toward D&A 4.5% (Ctrl+F "496,228"). DCF 5.5% = (7.0+6.0+5.5+5.0+4.0)/5.',
    ...
    "3s_capex_pct": 'Ctrl+F "680,802" → FY25 $680.8M / 6.1% of sales. Ctrl+F "$725.0 million and $745.0 million" → FY26 mid $735M / 7.0%. FY26 is up vs FY25, not down. Path 7.0 / 6.0 / 5.5 / 5.0 / 5.0: FY27 6.0% returns to the FY25 6.1% run-rate, then fades toward D&A 4.5% (Ctrl+F "496,228").',
