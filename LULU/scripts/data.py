...
JUST = {
    ...
    "drv_comp_sales": "FY26 Americas comp −4% vs FY25 −3% (10-K). China +14% vs +20% reported; RoW moderates from +9%.",
...
ASSUMPTION_SRC = {
    ...
    "drv_comp_sales": ("FY2025 10-K: segment comp sales", filing_url("FY2025")),
...
SOURCE_HINT = {
    ...
    "drv_comp_sales": 'Ctrl+F "Americas comparable sales decreased 3%" / "China Mainland comparable sales increased 20%"',
