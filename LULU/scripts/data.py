...
JUST = {
    ...
    "sc_capex_pct": "5.5% = (7.0+6.0+5.5+5.0+4.0)/5. Year 1 is the $735M guide (7.0% of FY26 sales); then fade toward the 4.5% D&A floor.",
    ...
    "3s_capex_pct": "FY26 7.0% = $735M guide mid / $10.425B sales. Then 6.0 / 5.5 / 5.0 / 5.0 (step off FY25 actual 6.1% toward D&A 4.5%).",
...
SOURCE_HINT = {
    ...
    "sc_capex_pct": 'Ctrl+F "$725.0 million and $745.0 million" → 2026 guide (one sentence). Mid $735M ÷ FY26 sales $10,425M = 7.0%. Ctrl+F "680,802" (one hit) → FY25 PP&E spend; 680,802 ÷ 11,102,600 = 6.1%. Ctrl+F "496,228" → D&A 4.5% (maintenance floor). DCF 5.5% is the 5-yr average of the fade 7.0 → 4.0: (7.0+6.0+5.5+5.0+4.0)/5 = 5.5%. We do not run the 7% build-year rate for all five years.',
    ...
    "3s_capex_pct": 'Ctrl+F "$725.0 million and $745.0 million" → 2026 guide. Mid $735M ÷ $10,425M sales = 7.0% (FY26). Ctrl+F "680,802" → FY25 actual 6.1%. Path 7.0 / 6.0 / 5.5 / 5.0 / 5.0 steps off that 6.1% toward D&A 4.5% (Ctrl+F "496,228").',
