...
LABEL_OVERRIDES = {
    ...
    "sc_gm": "Gross margin %",
    "sc_dso": "DSO (days) — flat vs FY25",
    "sc_ar": "Accounts receivable (balance)",
    "sc_dio": "FY25 DIO anchor (days)",
    "sc_inventory": "Inventories (balance)",
    "sc_dio_decline": "DIO decline (days / forecast yr)",
    "sc_dpo": "DPO (days) — flat vs FY25",
    "sc_ap": "Accounts payable (balance)",
    "sc_prepaid": "Prepaid expenses (% of revenue)",
    "sc_accrued": "Accrued liabilities (% of revenue)",
    "sc_coa": "Current operating assets (subtotal)",
    ...
    "np_ebit_store": "Store-channel EBIT (= Rev × 18.6%)",
    "np_ebit_ecomm": "E-commerce EBIT (= Rev × 23.6%)",
    "np_ebit_other": "Other-channels EBIT (= Rev × 9.1%)",
    "np_ebit_channel": "Channel EBIT (sum of sector EBIT)",
