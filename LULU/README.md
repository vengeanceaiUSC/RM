...
risk/reward is asymmetric (base DCF ~$134, target $140 allows
...
- EBIT margin: 13.2% clean/run-rate (Q2 18.8% minus 560bps of tariff refunds), interpolating to 15.5% by FY2030E. FY26 then adds the already-recognized $134.5M IEEPA refund once (~+1.3 ppt on full-year sales, so reported FY26 OM ≈ **15.2%** in our 3-statement). Do not add the Q2-only +560 bps to the full year.
